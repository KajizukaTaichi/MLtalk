...
impl Op {
    ...
    pub fn is_pure(&self) -> bool {
        match self {
            ...
            Op::LessThan(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::LessThanEq(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::GreaterThan(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::GreaterThanEq(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            ...
            Op::Apply(lhs, _, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::Assign(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::PipeLine(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::AssignAdd(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::AssignSub(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::AssignMul(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::AssignDiv(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::AssignMod(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
            Op::AssignPow(lhs, rhs) => lhs.is_pure() && rhs.is_pure(),
